        ...
        <div className='home-page'>
                ...
                <div className='containet'>
                    <div className='row'>
                        <div className='col-sm-6 d-flex d-sm-block flex-column align-items-center'>
                            ...
                            text-center text-sm-start'>Foodie Restaurant
                             </h1>
                             <MenuBtn/>
            ...
            <div className='container my-5'>
                ...
                <div className='col-lg-6 d-flex flex-column align-items-center justify-content-center'>
                        ...
                        <p>When I first went to the restaurant, I ordered a tasting menu. It was a smoked salmon and caviar. The preparation of the foods took short moments than the regular hours and the serving method was praiseworthy too.</p>
                        <p className='mb-5'> I ordered a tasting menu. It was a smoked salmon and caviar. The preparation of the foods took short.</p>
                        <Link to="/about">
